...
namespace WebMVC.Controllers
{
    public class BlogInfoesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("BlogId,Title,Subject,DateOfCreation,BlogUrl,Email")] DAL.BlogInfo blogInfo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("BlogId,Title,Subject,DateOfCreation,BlogUrl,Email")] DAL.BlogInfo blogInfo)
        {
